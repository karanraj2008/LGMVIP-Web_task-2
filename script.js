...
function getData(a)
{
    ...
    fetch(url).then((response)=>{
       ...
       var value=data;   
           ...
           document.getElementById('bruhimg1').src = img1;
           var img2=(value['data'][1]['avatar']);
           document.getElementById('bruhimg2').src = img2;
           var img3=(value['data'][2]['avatar']);
           document.getElementById('bruhimg3').src = img3;
           var img3=(value['data'][3]['avatar']);
           document.getElementById('bruhimg4').src = img3;
           var img3=(value['data'][4]['avatar']);
           document.getElementById('bruhimg5').src = img3;
           var img3=(value['data'][5]['avatar']);
           document.getElementById('bruhimg6').src = img3;
